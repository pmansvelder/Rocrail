...
echo ""
echo "*** Rocrail makewin-root.sh starting (see www.rocrail.net)..."
echo ""
...
echo "Building rocrail-root-setup-$VERSION.$PATCH-rev$BAZAARREV-$TYPE-$DIST.exe"
echo ""
...
cd ../rocrail/package
pwd
sed s/\<BZR\>/$BAZAARREV/ < rocrail-root-template.iss > rocrail-temp2.iss
