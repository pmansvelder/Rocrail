...
class cardlggen : public wxDialog 
{
	...
	protected:
		...
		virtual void aboxID( wxMouseEvent& event ) { event.Skip(); }
		virtual void aboxRoadname( wxMouseEvent& event ) { event.Skip(); }
		virtual void onImageChooser( wxCommandEvent& event ) { event.Skip(); }
		virtual void onTypeSelect( wxCommandEvent& event ) { event.Skip(); }
		virtual void aboxManuId( wxMouseEvent& event ) { event.Skip(); }
		virtual void aboxCatNr( wxMouseEvent& event ) { event.Skip(); }
