...
void PlanPanelProps::initLabels() {
  ...
  m_labTabIdx->SetLabel( wxGetApp().getMsg( "tabidx" ) );
...
void PlanPanelProps::initValues() {
  ...
  m_TabIdx->SetValue( wZLevel.gettabidx( m_Props ) );
}
...
////@begin PlanPanelProps content construction
    ...
    m_labTabIdx = new wxStaticText( itemDialog1, wxID_ANY, _("Tab index"), wxDefaultPosition, wxDefaultSize, 0 );
    itemFlexGridSizer3->Add(m_labTabIdx, 0, wxALIGN_RIGHT|wxALIGN_CENTER_VERTICAL|wxALL, 5);

    m_TabIdx = new wxSpinCtrl( itemDialog1, wxID_ANY, wxT("-1"), wxDefaultPosition, wxDefaultSize, wxSP_ARROW_KEYS, -1, 1000, -1 );
    m_TabIdx->Enable(false);
    itemFlexGridSizer3->Add(m_TabIdx, 0, wxALIGN_LEFT|wxALIGN_CENTER_VERTICAL|wxALL, 5);
