...
class AccDecGenDlg : public wxDialog 
{
	...
	protected:
		...
		wxPanel* m_UsagePanel;
		wxListCtrl* m_UsageList;
		...
		virtual void onOpenDoc( wxCommandEvent& event ) { event.Skip(); }
		virtual void onCVCell( wxGridEvent& event ) { event.Skip(); }
		virtual void onCVModify( wxCommandEvent& event ) { event.Skip(); }
		virtual void onUsageListActivated( wxListEvent& event ) { event.Skip(); }
		virtual void onUsageListSelected( wxListEvent& event ) { event.Skip(); }
