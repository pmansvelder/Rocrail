...
////@begin RocrailIniDialog event table entries
    ...
    EVT_BUTTON( ID_BUTTON_LIBPATH, RocrailIniDialog::OnButtonLibpathClick )
    EVT_BUTTON( ID_BUTTON_IMGPATH, RocrailIniDialog::OnButtonImgpathClick )
    EVT_BUTTON( ID_BUTTON_ICONPATH, RocrailIniDialog::OnButtonIconpathClick )
    ...
    EVT_BUTTON( ID_SELECT_ABOXHOME, RocrailIniDialog::OnSelectAboxhomeClick )
...
void RocrailIniDialog::initLabels() {
  ...
  m_labMaxBackup->SetLabel( wxGetApp().getMsg( "max" ) );
  ...
  m_labXmlScriptPath->SetLabel( wxGetApp().getMsg( "xmlscriptpath" ) );
...
void RocrailIniDialog::initValues() {
  ...
  m_LocoFile->SetValue( wxString( wRocRail.getlocs( m_Props ),wxConvUTF8 ) );
  m_MaxBackup->SetValue( wRocRail.getmaxbackup( m_Props ) );
  ...
  m_IconPath->SetValue( wxString(wRocRail.geticonpath( m_Props ),wxConvUTF8) );
  ...
  m_XmlScriptPath->SetValue( wxString(wRocRail.getxmlscriptpath( m_Props ),wxConvUTF8) );
  ...
  m_FSUTF8->SetValue( wRocRail.isfsutf8( m_Props )?true:false );
  ...
  m_ABoxHome->SetValue( wxString( wRocRail.getaboxhome(m_Props), wxConvUTF8) );
  ...
  m_PowerOnAtInit->SetValue(wRocRail.ispoweronatinit(m_Props)?true:false);
  m_Shutdown->SetValue(wRocRail.isshutdownonexit(m_Props)?true:false);
  m_NoDevCheck->SetValue(wRocRail.isnodevcheck(m_Props)?true:false);
...
void RocrailIniDialog::evaluate() {
  ...
  wRocRail.setlocs( m_Props, m_LocoFile->GetValue().mb_str(wxConvUTF8) );
  wRocRail.setbackup( m_Props, m_Backup->IsChecked()?True:False );
  wRocRail.setmaxbackup( m_Props, m_MaxBackup->GetValue() );
  ...
  wRocRail.seticonpath( m_Props, m_IconPath->GetValue().mb_str(wxConvUTF8) );
  ...
  wRocRail.setxmlscriptpath( m_Props, m_XmlScriptPath->GetValue().mb_str(wxConvUTF8) );
  iONode trace = wRocRail.gettrace( m_Props );
  ...
  wRocRail.setfsutf8( m_Props, m_FSUTF8->IsChecked()?True:False );
  ...
  wRocRail.setaboxhome(m_Props, m_ABoxHome->GetValue().mb_str(wxConvUTF8) );
  ...
  wRocRail.setpoweronatinit(m_Props, m_PowerOnAtInit->IsChecked() ? True:False);
  wRocRail.setshutdownonexit(m_Props, m_Shutdown->IsChecked() ? True:False);
  wRocRail.setnodevcheck(m_Props, m_NoDevCheck->IsChecked() ? True:False);
...
////@begin RocrailIniDialog member initialisation
    ...
    m_LabelLibPath = NULL;
    m_LibPath = NULL;
    m_SelectLibPath = NULL;
    m_labImgPath = NULL;
    m_ImgPath = NULL;
    m_SelectImgPath = NULL;
    m_labIconPath = NULL;
    m_IconPath = NULL;
    m_SelectIconPath = NULL;
    m_labIssuesPath = NULL;
    m_IssuePath = NULL;
    m_SelectIssuesPath = NULL;
    m_labSoundPath = NULL;
    m_SoundPath = NULL;
    m_SelectSoundPath = NULL;
    m_labSoundPlayer = NULL;
    m_SoundPlayer = NULL;
    m_SelectSoundPlayer = NULL;
    m_SoundPlayerLocation = NULL;
    m_labXmlScriptPath = NULL;
    m_XmlScriptPath = NULL;
    m_SelectXmlScriptPath = NULL;
    m_ScBox = NULL;
    m_labScSensor = NULL;
    m_ScSensor = NULL;
    m_labScIID = NULL;
...
////@begin RocrailIniDialog content construction
    ...
    itemFlexGridSizer6->Add(m_LabelPlanfile, 0, wxALIGN_RIGHT|wxALIGN_CENTER_VERTICAL|wxALL|wxADJUST_MINSIZE, 5);
    ...
    itemFlexGridSizer6->Add(m_Backup, 0, wxALIGN_RIGHT|wxALIGN_CENTER_VERTICAL|wxALL, 5);

    wxFlexGridSizer* itemFlexGridSizer22 = new wxFlexGridSizer(0, 3, 0, 0);
    itemFlexGridSizer6->Add(itemFlexGridSizer22, 0, wxGROW|wxALIGN_CENTER_VERTICAL, 5);
    m_BackupPath = new wxTextCtrl( m_GeneralPanel, wxID_ANY, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0 );
    itemFlexGridSizer22->Add(m_BackupPath, 0, wxGROW|wxALIGN_CENTER_VERTICAL|wxALL, 5);

    m_labMaxBackup = new wxStaticText( m_GeneralPanel, wxID_ANY, _("Max."), wxDefaultPosition, wxDefaultSize, 0 );
    itemFlexGridSizer22->Add(m_labMaxBackup, 0, wxALIGN_RIGHT|wxALIGN_CENTER_VERTICAL|wxLEFT|wxTOP|wxBOTTOM, 5);

    m_MaxBackup = new wxSpinCtrl( m_GeneralPanel, wxID_ANY, wxT("100"), wxDefaultPosition, wxDefaultSize, wxSP_ARROW_KEYS, 10, 1000, 100 );
    itemFlexGridSizer22->Add(m_MaxBackup, 0, wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL|wxLEFT|wxRIGHT, 5);
    ...
    itemFlexGridSizer6->Add(itemFlexGridSizer27, 1, wxGROW|wxALIGN_CENTER_VERTICAL, 5);
    m_KeyPath = new wxTextCtrl( m_GeneralPanel, wxID_ANY, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0 );
    itemFlexGridSizer27->Add(m_KeyPath, 0, wxGROW|wxALIGN_CENTER_VERTICAL|wxLEFT|wxRIGHT|wxBOTTOM, 5);

    wxButton* itemButton29 = new wxButton( m_GeneralPanel, ID_BUTTON_KEYPATH, _("..."), wxDefaultPosition, wxSize(50, -1), 0 );
    itemFlexGridSizer27->Add(itemButton29, 0, wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL|wxLEFT|wxRIGHT|wxBOTTOM, 5);
    ...
    itemFlexGridSizer6->Add(m_LabelLibPath, 0, wxALIGN_RIGHT|wxALIGN_CENTER_VERTICAL|wxLEFT|wxRIGHT|wxBOTTOM|wxADJUST_MINSIZE, 5);

    wxFlexGridSizer* itemFlexGridSizer31 = new wxFlexGridSizer(0, 2, 0, 0);
    itemFlexGridSizer6->Add(itemFlexGridSizer31, 0, wxGROW|wxALIGN_CENTER_VERTICAL, 5);
    m_LibPath = new wxTextCtrl( m_GeneralPanel, ID_TEXTCTRL_RR_LIBPATH, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0 );
    itemFlexGridSizer31->Add(m_LibPath, 0, wxGROW|wxALIGN_CENTER_VERTICAL|wxLEFT|wxRIGHT|wxBOTTOM, 5);

    m_SelectLibPath = new wxButton( m_GeneralPanel, ID_BUTTON_LIBPATH, _("..."), wxDefaultPosition, wxSize(50, -1), 0 );
    itemFlexGridSizer31->Add(m_SelectLibPath, 0, wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL|wxLEFT|wxRIGHT|wxBOTTOM, 5);

    itemFlexGridSizer31->AddGrowableCol(0);
    ...
    itemFlexGridSizer6->Add(itemFlexGridSizer35, 0, wxGROW|wxALIGN_CENTER_VERTICAL, 5);
    m_ImgPath = new wxTextCtrl( m_GeneralPanel, wxID_ANY, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0 );
    itemFlexGridSizer35->Add(m_ImgPath, 0, wxGROW|wxALIGN_CENTER_VERTICAL|wxLEFT|wxRIGHT|wxBOTTOM, 5);

    m_SelectImgPath = new wxButton( m_GeneralPanel, ID_BUTTON_IMGPATH, _("..."), wxDefaultPosition, wxSize(50, -1), 0 );
    itemFlexGridSizer35->Add(m_SelectImgPath, 0, wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL|wxLEFT|wxRIGHT|wxBOTTOM, 5);

    itemFlexGridSizer35->AddGrowableCol(0);
    ...
    itemFlexGridSizer6->Add(itemFlexGridSizer39, 0, wxGROW|wxALIGN_CENTER_VERTICAL, 5);
    m_IconPath = new wxTextCtrl( m_GeneralPanel, wxID_ANY, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0 );
    itemFlexGridSizer39->Add(m_IconPath, 0, wxGROW|wxALIGN_CENTER_VERTICAL|wxLEFT|wxRIGHT|wxBOTTOM, 5);

    m_SelectIconPath = new wxButton( m_GeneralPanel, ID_BUTTON_ICONPATH, _("..."), wxDefaultPosition, wxSize(50, -1), 0 );
    itemFlexGridSizer39->Add(m_SelectIconPath, 0, wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL|wxLEFT|wxRIGHT|wxBOTTOM, 5);
    ...
    itemFlexGridSizer6->Add(itemFlexGridSizer43, 0, wxGROW|wxALIGN_CENTER_VERTICAL, 5);
    m_IssuePath = new wxTextCtrl( m_GeneralPanel, wxID_ANY, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0 );
    itemFlexGridSizer43->Add(m_IssuePath, 0, wxGROW|wxALIGN_CENTER_VERTICAL|wxLEFT|wxRIGHT|wxBOTTOM, 5);

    m_SelectIssuesPath = new wxButton( m_GeneralPanel, ID_BUTTON_ISSUESPATH, _("..."), wxDefaultPosition, wxSize(50, -1), 0 );
    itemFlexGridSizer43->Add(m_SelectIssuesPath, 0, wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL|wxLEFT|wxRIGHT|wxBOTTOM, 5);

    itemFlexGridSizer43->AddGrowableCol(0);
    ...
    itemFlexGridSizer6->Add(itemFlexGridSizer47, 0, wxGROW|wxALIGN_CENTER_VERTICAL, 5);
    m_SoundPath = new wxTextCtrl( m_GeneralPanel, wxID_ANY, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0 );
    itemFlexGridSizer47->Add(m_SoundPath, 0, wxGROW|wxALIGN_CENTER_VERTICAL|wxLEFT|wxRIGHT|wxBOTTOM, 5);

    m_SelectSoundPath = new wxButton( m_GeneralPanel, ID_BUTTON_SOUNDPATH, _("..."), wxDefaultPosition, wxSize(50, -1), 0 );
    itemFlexGridSizer47->Add(m_SelectSoundPath, 0, wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL|wxLEFT|wxRIGHT|wxBOTTOM, 5);
    ...
    wxFlexGridSizer* itemFlexGridSizer51 = new wxFlexGridSizer(0, 3, 0, 0);
    itemFlexGridSizer6->Add(itemFlexGridSizer51, 0, wxGROW|wxALIGN_CENTER_VERTICAL, 5);
    m_SoundPlayer = new wxTextCtrl( m_GeneralPanel, wxID_ANY, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0 );
    itemFlexGridSizer51->Add(m_SoundPlayer, 0, wxGROW|wxALIGN_CENTER_VERTICAL|wxLEFT|wxRIGHT|wxBOTTOM, 5);

    m_SelectSoundPlayer = new wxButton( m_GeneralPanel, ID_BUTTON_SOUNDPLAYER, _("..."), wxDefaultPosition, wxSize(50, -1), 0 );
    itemFlexGridSizer51->Add(m_SelectSoundPlayer, 0, wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL|wxLEFT|wxRIGHT|wxBOTTOM, 5);
    ...
    itemFlexGridSizer51->Add(m_SoundPlayerLocation, 0, wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL|wxLEFT|wxRIGHT|wxBOTTOM, 5);

    itemFlexGridSizer51->AddGrowableCol(0);

    m_labXmlScriptPath = new wxStaticText( m_GeneralPanel, wxID_ANY, _("XmlScript path"), wxDefaultPosition, wxDefaultSize, 0 );
    itemFlexGridSizer6->Add(m_labXmlScriptPath, 0, wxALIGN_RIGHT|wxALIGN_CENTER_VERTICAL|wxLEFT|wxRIGHT|wxBOTTOM, 5);

    wxFlexGridSizer* itemFlexGridSizer56 = new wxFlexGridSizer(0, 2, 0, 0);
    itemFlexGridSizer6->Add(itemFlexGridSizer56, 0, wxGROW|wxALIGN_CENTER_VERTICAL, 5);
    m_XmlScriptPath = new wxTextCtrl( m_GeneralPanel, wxID_ANY, _("."), wxDefaultPosition, wxDefaultSize, 0 );
    itemFlexGridSizer56->Add(m_XmlScriptPath, 0, wxGROW|wxALIGN_CENTER_VERTICAL|wxLEFT|wxRIGHT|wxBOTTOM, 5);

    m_SelectXmlScriptPath = new wxButton( m_GeneralPanel, ID_BUTTON_XMLSCRIPTPATH, _("..."), wxDefaultPosition, wxSize(50, -1), 0 );
    itemFlexGridSizer56->Add(m_SelectXmlScriptPath, 0, wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL|wxLEFT|wxRIGHT|wxBOTTOM, 5);
    ...
    wxStaticBoxSizer* itemStaticBoxSizer59 = new wxStaticBoxSizer(m_ScBox, wxVERTICAL);
    itemBoxSizer5->Add(itemStaticBoxSizer59, 0, wxGROW|wxLEFT|wxRIGHT, 5);
    wxFlexGridSizer* itemFlexGridSizer60 = new wxFlexGridSizer(0, 4, 0, 0);
    ...
    itemFlexGridSizer60->Add(m_labScSensor, 0, wxALIGN_RIGHT|wxALIGN_CENTER_VERTICAL|wxLEFT|wxRIGHT, 5);
    ...
    itemFlexGridSizer60->Add(m_ScSensor, 0, wxGROW|wxALIGN_CENTER_VERTICAL|wxLEFT|wxRIGHT, 5);

    m_labScIID = new wxStaticText( m_GeneralPanel, wxID_ANY, _("IID"), wxDefaultPosition, wxDefaultSize, 0 );
    itemFlexGridSizer60->Add(m_labScIID, 0, wxALIGN_RIGHT|wxALIGN_CENTER_VERTICAL|wxLEFT|wxRIGHT, 5);

    m_ScIID = new wxTextCtrl( m_GeneralPanel, wxID_ANY, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0 );
    itemFlexGridSizer60->Add(m_ScIID, 0, wxALIGN_LEFT|wxALIGN_CENTER_VERTICAL|wxLEFT|wxRIGHT, 5);

    itemFlexGridSizer60->AddGrowableCol(1);

    wxBoxSizer* itemBoxSizer65 = new wxBoxSizer(wxHORIZONTAL);
    itemBoxSizer5->Add(itemBoxSizer65, 0, wxALIGN_LEFT|wxTOP, 5);
    wxFlexGridSizer* itemFlexGridSizer66 = new wxFlexGridSizer(0, 8, 0, 0);
    itemBoxSizer65->Add(itemFlexGridSizer66, 0, wxALIGN_CENTER_VERTICAL, 5);
    m_labPTIID = new wxStaticText( m_GeneralPanel, wxID_ANY, _("PT IID"), wxDefaultPosition, wxDefaultSize, 0 );
    itemFlexGridSizer66->Add(m_labPTIID, 0, wxALIGN_RIGHT|wxALIGN_CENTER_VERTICAL|wxLEFT|wxRIGHT|wxBOTTOM|wxADJUST_MINSIZE, 5);

    m_PTIID = new wxTextCtrl( m_GeneralPanel, wxID_ANY, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0 );
    itemFlexGridSizer66->Add(m_PTIID, 0, wxALIGN_LEFT|wxALIGN_CENTER_VERTICAL|wxLEFT|wxRIGHT|wxBOTTOM, 5);

    m_labLCIID = new wxStaticText( m_GeneralPanel, wxID_ANY, _("LC IID"), wxDefaultPosition, wxDefaultSize, 0 );
    itemFlexGridSizer66->Add(m_labLCIID, 0, wxALIGN_RIGHT|wxALIGN_CENTER_VERTICAL|wxLEFT|wxRIGHT|wxBOTTOM, 5);

    m_LCIID = new wxTextCtrl( m_GeneralPanel, wxID_ANY, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0 );
    itemFlexGridSizer66->Add(m_LCIID, 0, wxALIGN_LEFT|wxALIGN_CENTER_VERTICAL|wxLEFT|wxRIGHT|wxBOTTOM, 5);

    m_labDPIID = new wxStaticText( m_GeneralPanel, wxID_ANY, _("DP IID"), wxDefaultPosition, wxDefaultSize, 0 );
    itemFlexGridSizer66->Add(m_labDPIID, 0, wxALIGN_RIGHT|wxALIGN_CENTER_VERTICAL|wxLEFT|wxRIGHT|wxBOTTOM, 5);

    m_DPIID = new wxTextCtrl( m_GeneralPanel, wxID_ANY, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0 );
    itemFlexGridSizer66->Add(m_DPIID, 0, wxALIGN_LEFT|wxALIGN_CENTER_VERTICAL|wxLEFT|wxRIGHT|wxBOTTOM, 5);

    m_labSVIID = new wxStaticText( m_GeneralPanel, wxID_ANY, _("SV IID"), wxDefaultPosition, wxDefaultSize, 0 );
    itemFlexGridSizer66->Add(m_labSVIID, 0, wxALIGN_RIGHT|wxALIGN_CENTER_VERTICAL|wxLEFT|wxRIGHT|wxBOTTOM, 5);

    m_SVIID = new wxTextCtrl( m_GeneralPanel, wxID_ANY, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0 );
    itemFlexGridSizer66->Add(m_SVIID, 0, wxALIGN_LEFT|wxALIGN_CENTER_VERTICAL|wxLEFT|wxRIGHT|wxBOTTOM, 5);

    m_FSUTF8 = new wxCheckBox( m_GeneralPanel, wxID_ANY, _("UTF-8"), wxDefaultPosition, wxDefaultSize, 0 );
    m_FSUTF8->SetValue(false);
    itemBoxSizer65->Add(m_FSUTF8, 0, wxALIGN_CENTER_VERTICAL|wxLEFT|wxRIGHT, 5);
    ...
    m_TracePanel->SetSizer(itemBoxSizer77);

    wxStaticBox* itemStaticBoxSizer78Static = new wxStaticBox(m_TracePanel, wxID_ANY, _("User Levels"));
    m_TraceLevel = new wxStaticBoxSizer(itemStaticBoxSizer78Static, wxVERTICAL);
    itemBoxSizer77->Add(m_TraceLevel, 0, wxGROW|wxALL, 5);
    ...
    wxStaticBoxSizer* itemStaticBoxSizer82 = new wxStaticBoxSizer(m_DevTraceLevel, wxVERTICAL);
    itemBoxSizer77->Add(itemStaticBoxSizer82, 0, wxGROW|wxALL, 5);
    ...
    itemStaticBoxSizer82->Add(m_Byte, 0, wxALIGN_LEFT|wxLEFT|wxRIGHT|wxTOP, 5);

    m_Info = new wxCheckBox( m_TracePanel, wxID_ANY, _("Info"), wxDefaultPosition, wxDefaultSize, 0 );
    m_Info->SetValue(false);
    itemStaticBoxSizer82->Add(m_Info, 0, wxALIGN_LEFT|wxLEFT|wxRIGHT|wxTOP, 5);
    ...
    itemStaticBoxSizer82->Add(m_Debug, 0, wxALIGN_LEFT|wxALL, 5);

    wxFlexGridSizer* itemFlexGridSizer86 = new wxFlexGridSizer(0, 2, 0, 0);
    itemStaticBoxSizer82->Add(itemFlexGridSizer86, 0, wxALIGN_LEFT, 5);
    m_labNrTraceFiles = new wxStaticText( m_TracePanel, wxID_ANY, _("Number of files"), wxDefaultPosition, wxDefaultSize, 0 );
    itemFlexGridSizer86->Add(m_labNrTraceFiles, 0, wxALIGN_LEFT|wxALIGN_CENTER_VERTICAL|wxLEFT|wxRIGHT|wxTOP, 5);

    m_NrTraceFiles = new wxSpinCtrl( m_TracePanel, wxID_ANY, wxT("10"), wxDefaultPosition, wxDefaultSize, wxSP_ARROW_KEYS, 0, 100, 10 );
    itemFlexGridSizer86->Add(m_NrTraceFiles, 0, wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL|wxLEFT|wxRIGHT|wxTOP, 5);

    m_labTraceFileSize = new wxStaticText( m_TracePanel, wxID_ANY, _("File size"), wxDefaultPosition, wxDefaultSize, 0 );
    itemFlexGridSizer86->Add(m_labTraceFileSize, 0, wxALIGN_LEFT|wxALIGN_CENTER_VERTICAL|wxLEFT|wxRIGHT|wxTOP, 5);
    ...
    itemFlexGridSizer86->Add(m_TraceFileSize, 0, wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL|wxLEFT|wxRIGHT|wxBOTTOM, 5);

    itemFlexGridSizer86->AddGrowableCol(1);

    wxStaticLine* itemStaticLine91 = new wxStaticLine( m_TracePanel, wxID_STATIC, wxDefaultPosition, wxDefaultSize, wxLI_HORIZONTAL );
    itemStaticBoxSizer82->Add(itemStaticLine91, 0, wxGROW|wxALL, 5);
    ...
    itemStaticBoxSizer82->Add(m_SendAllTraces, 0, wxALIGN_LEFT|wxLEFT|wxRIGHT|wxTOP, 5);

    wxFlexGridSizer* itemFlexGridSizer93 = new wxFlexGridSizer(0, 2, 0, 0);
    itemBoxSizer77->Add(itemFlexGridSizer93, 0, wxGROW|wxALL, 5);
    m_LabelTraceFile = new wxStaticText( m_TracePanel, wxID_STATIC_RR_TRACEFILE, _("TraceFile"), wxDefaultPosition, wxDefaultSize, 0 );
    itemFlexGridSizer93->Add(m_LabelTraceFile, 0, wxALIGN_RIGHT|wxALIGN_CENTER_VERTICAL|wxLEFT|wxRIGHT|wxTOP|wxADJUST_MINSIZE, 5);

    m_TraceFile = new wxTextCtrl( m_TracePanel, ID_TEXTCTRL_RR_TRACEFILE, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0 );
    itemFlexGridSizer93->Add(m_TraceFile, 0, wxGROW|wxALIGN_CENTER_VERTICAL|wxLEFT|wxRIGHT|wxTOP, 5);

    m_labProtPath = new wxStaticText( m_TracePanel, wxID_ANY, _("Path"), wxDefaultPosition, wxDefaultSize, 0 );
    itemFlexGridSizer93->Add(m_labProtPath, 0, wxALIGN_RIGHT|wxALIGN_CENTER_VERTICAL|wxLEFT|wxRIGHT|wxTOP, 5);

    m_ProtPath = new wxTextCtrl( m_TracePanel, wxID_ANY, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0 );
    itemFlexGridSizer93->Add(m_ProtPath, 0, wxGROW|wxALIGN_CENTER_VERTICAL|wxLEFT|wxRIGHT|wxTOP, 5);
    ...
    m_ServicePanel->SetSizer(itemBoxSizer99);

    wxBoxSizer* itemBoxSizer100 = new wxBoxSizer(wxVERTICAL);
    itemBoxSizer99->Add(itemBoxSizer100, 0, wxALIGN_TOP|wxALL, 5);
    wxStaticBox* itemStaticBoxSizer101Static = new wxStaticBox(m_ServicePanel, wxID_ANY, _("HTTP Service"));
    m_HttpBox = new wxStaticBoxSizer(itemStaticBoxSizer101Static, wxHORIZONTAL);
    itemBoxSizer100->Add(m_HttpBox, 0, wxGROW|wxLEFT|wxRIGHT|wxTOP, 5);
    ...
    wxStaticBox* itemStaticBoxSizer106Static = new wxStaticBox(m_ServicePanel, wxID_ANY, _("Clock Service"));
    m_ClockBox = new wxStaticBoxSizer(itemStaticBoxSizer106Static, wxVERTICAL);
    itemBoxSizer100->Add(m_ClockBox, 0, wxGROW|wxLEFT|wxRIGHT|wxTOP, 5);
    wxFlexGridSizer* itemFlexGridSizer107 = new wxFlexGridSizer(0, 7, 0, 0);
    m_ClockBox->Add(itemFlexGridSizer107, 0, wxALIGN_CENTER_HORIZONTAL, 5);
    m_labDevider = new wxStaticText( m_ServicePanel, wxID_STATIC_RR_CLOCK_DEVIDER, _("divider"), wxDefaultPosition, wxDefaultSize, 0 );
    itemFlexGridSizer107->Add(m_labDevider, 0, wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL|wxLEFT|wxTOP|wxBOTTOM|wxADJUST_MINSIZE, 5);
    ...
    itemFlexGridSizer107->Add(m_Divider, 0, wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL|wxLEFT|wxTOP|wxBOTTOM, 5);
    ...
    itemFlexGridSizer107->Add(m_ClockUpdate, 0, wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL|wxALL, 5);

    m_labHour = new wxStaticText( m_ServicePanel, wxID_STATIC_RR_CLOCK_HOUR, _("hour"), wxDefaultPosition, wxDefaultSize, 0 );
    itemFlexGridSizer107->Add(m_labHour, 0, wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL|wxLEFT|wxTOP|wxBOTTOM|wxADJUST_MINSIZE, 5);
    ...
    itemFlexGridSizer107->Add(m_Hour, 0, wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL|wxALL, 5);

    m_labMinute = new wxStaticText( m_ServicePanel, wxID_STATIC_RR_CLOCK_MINUTE, _("minute"), wxDefaultPosition, wxDefaultSize, 0 );
    itemFlexGridSizer107->Add(m_labMinute, 0, wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL|wxLEFT|wxTOP|wxBOTTOM|wxADJUST_MINSIZE, 5);
    ...
    itemFlexGridSizer107->Add(m_Minute, 0, wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL|wxALL, 5);

    wxFlexGridSizer* itemFlexGridSizer115 = new wxFlexGridSizer(0, 2, 0, 0);
    m_ClockBox->Add(itemFlexGridSizer115, 0, wxALIGN_LEFT, 5);
    ...
    itemFlexGridSizer115->Add(m_StopClockAtPowerOff, 0, wxALIGN_LEFT|wxALIGN_CENTER_VERTICAL|wxALL, 5);

    wxStaticBox* itemStaticBoxSizer117Static = new wxStaticBox(m_ServicePanel, wxID_ANY, _("Client Service"));
    m_ClientBox = new wxStaticBoxSizer(itemStaticBoxSizer117Static, wxVERTICAL);
    itemBoxSizer100->Add(m_ClientBox, 0, wxGROW|wxALL, 5);
    wxFlexGridSizer* itemFlexGridSizer118 = new wxFlexGridSizer(0, 2, 0, 0);
    m_ClientBox->Add(itemFlexGridSizer118, 1, wxGROW, 5);
    m_LabelClientPort = new wxStaticText( m_ServicePanel, wxID_STATIC_RR_CLIENTPORT, _("port"), wxDefaultPosition, wxDefaultSize, 0 );
    itemFlexGridSizer118->Add(m_LabelClientPort, 0, wxALIGN_RIGHT|wxALIGN_CENTER_VERTICAL|wxALL|wxADJUST_MINSIZE, 5);
    ...
    itemFlexGridSizer118->Add(m_ClientPort, 0, wxALIGN_LEFT|wxALIGN_CENTER_VERTICAL|wxALL, 5);

    m_LabelMaxCon = new wxStaticText( m_ServicePanel, wxID_STATIC_RR_MAXCON, _("max."), wxDefaultPosition, wxDefaultSize, 0 );
    itemFlexGridSizer118->Add(m_LabelMaxCon, 0, wxALIGN_RIGHT|wxALIGN_CENTER_VERTICAL|wxLEFT|wxRIGHT|wxBOTTOM|wxADJUST_MINSIZE, 5);
    ...
    itemFlexGridSizer118->Add(m_MaxCon, 0, wxALIGN_LEFT|wxALIGN_CENTER_VERTICAL|wxLEFT|wxRIGHT|wxBOTTOM, 5);

    m_labControlCode = new wxStaticText( m_ServicePanel, wxID_ANY, _("Control code"), wxDefaultPosition, wxDefaultSize, 0 );
    itemFlexGridSizer118->Add(m_labControlCode, 0, wxALIGN_RIGHT|wxALIGN_CENTER_VERTICAL|wxLEFT|wxRIGHT|wxBOTTOM, 5);

    m_ControlCode = new wxTextCtrl( m_ServicePanel, wxID_ANY, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0 );
    itemFlexGridSizer118->Add(m_ControlCode, 0, wxGROW|wxALIGN_CENTER_VERTICAL|wxLEFT|wxRIGHT|wxBOTTOM, 5);

    m_labSlaveCode = new wxStaticText( m_ServicePanel, wxID_ANY, _("Slave code"), wxDefaultPosition, wxDefaultSize, 0 );
    itemFlexGridSizer118->Add(m_labSlaveCode, 0, wxALIGN_RIGHT|wxALIGN_CENTER_VERTICAL|wxLEFT|wxRIGHT|wxBOTTOM, 5);

    m_SlaveCode = new wxTextCtrl( m_ServicePanel, wxID_ANY, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0 );
    itemFlexGridSizer118->Add(m_SlaveCode, 0, wxGROW|wxALIGN_CENTER_VERTICAL|wxLEFT|wxRIGHT|wxBOTTOM, 5);

    itemFlexGridSizer118->AddGrowableCol(1);

    wxFlexGridSizer* itemFlexGridSizer127 = new wxFlexGridSizer(0, 1, 0, 0);
    m_ClientBox->Add(itemFlexGridSizer127, 0, wxGROW, 5);
    ...
    itemFlexGridSizer127->Add(m_OnlyFirstMaster, 0, wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL|wxLEFT|wxRIGHT|wxTOP, 5);

    wxStaticLine* itemStaticLine129 = new wxStaticLine( m_ServicePanel, wxID_STATIC, wxDefaultPosition, wxDefaultSize, wxLI_VERTICAL );
    itemBoxSizer99->Add(itemStaticLine129, 0, wxGROW|wxALL, 5);

    wxBoxSizer* itemBoxSizer130 = new wxBoxSizer(wxVERTICAL);
    itemBoxSizer99->Add(itemBoxSizer130, 0, wxALIGN_TOP|wxALL, 5);
    m_SrcpService = new wxStaticBox(m_ServicePanel, wxID_ANY, _("SRCP Service"));
    wxStaticBoxSizer* itemStaticBoxSizer131 = new wxStaticBoxSizer(m_SrcpService, wxVERTICAL);
    itemBoxSizer130->Add(itemStaticBoxSizer131, 0, wxGROW|wxLEFT|wxRIGHT|wxTOP, 5);
    wxFlexGridSizer* itemFlexGridSizer132 = new wxFlexGridSizer(0, 3, 0, 0);
    itemStaticBoxSizer131->Add(itemFlexGridSizer132, 0, wxGROW, 5);
    m_labSrcpPort = new wxStaticText( m_ServicePanel, wxID_ANY, _("port"), wxDefaultPosition, wxDefaultSize, 0 );
    itemFlexGridSizer132->Add(m_labSrcpPort, 0, wxALIGN_RIGHT|wxALIGN_CENTER_VERTICAL|wxALL, 5);

    m_SrcpPort = new wxSpinCtrl( m_ServicePanel, wxID_ANY, wxT("0"), wxDefaultPosition, wxSize(100, -1), wxSP_ARROW_KEYS, 0, 65536, 0 );
    itemFlexGridSizer132->Add(m_SrcpPort, 0, wxALIGN_LEFT|wxALIGN_CENTER_VERTICAL|wxALL, 5);
    ...
    itemFlexGridSizer132->Add(m_SrcpServiceActive, 0, wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL|wxALL, 5);

    wxFlexGridSizer* itemFlexGridSizer136 = new wxFlexGridSizer(0, 2, 0, 0);
    itemStaticBoxSizer131->Add(itemFlexGridSizer136, 0, wxGROW, 5);
    m_labSRCPDevice = new wxStaticText( m_ServicePanel, wxID_ANY, _("device"), wxDefaultPosition, wxDefaultSize, 0 );
    itemFlexGridSizer136->Add(m_labSRCPDevice, 0, wxALIGN_RIGHT|wxALIGN_CENTER_VERTICAL|wxALL, 5);
    ...
    itemFlexGridSizer136->Add(m_SRCPDevice, 0, wxGROW|wxALIGN_CENTER_VERTICAL|wxALL, 5);

    itemFlexGridSizer136->AddGrowableCol(1);

    m_SNMPBox = new wxStaticBox(m_ServicePanel, wxID_ANY, _("SNMP Service"));
    wxStaticBoxSizer* itemStaticBoxSizer139 = new wxStaticBoxSizer(m_SNMPBox, wxVERTICAL);
    itemBoxSizer130->Add(itemStaticBoxSizer139, 0, wxGROW|wxLEFT|wxRIGHT|wxTOP, 5);
    wxFlexGridSizer* itemFlexGridSizer140 = new wxFlexGridSizer(0, 3, 0, 0);
    itemStaticBoxSizer139->Add(itemFlexGridSizer140, 0, wxGROW, 5);
    m_labSnmpPort = new wxStaticText( m_ServicePanel, wxID_ANY, _("port"), wxDefaultPosition, wxDefaultSize, 0 );
    itemFlexGridSizer140->Add(m_labSnmpPort, 0, wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL|wxALL, 5);

    m_SnmpPort = new wxSpinCtrl( m_ServicePanel, wxID_ANY, wxT("0"), wxDefaultPosition, wxSize(100, -1), wxSP_ARROW_KEYS, 0, 65536, 0 );
    itemFlexGridSizer140->Add(m_SnmpPort, 0, wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL|wxALL, 5);
    ...
    itemFlexGridSizer140->Add(m_SnmpServiceActive, 0, wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL|wxALL, 5);

    m_SNMPTrapBox = new wxStaticBox(m_ServicePanel, wxID_ANY, _("Trap"));
    wxStaticBoxSizer* itemStaticBoxSizer144 = new wxStaticBoxSizer(m_SNMPTrapBox, wxVERTICAL);
    itemStaticBoxSizer139->Add(itemStaticBoxSizer144, 0, wxGROW|wxLEFT|wxRIGHT|wxBOTTOM, 5);
    wxFlexGridSizer* itemFlexGridSizer145 = new wxFlexGridSizer(0, 4, 0, 0);
    itemStaticBoxSizer144->Add(itemFlexGridSizer145, 0, wxGROW, 5);
    m_labSnmpTrapHost = new wxStaticText( m_ServicePanel, wxID_ANY, _("Host"), wxDefaultPosition, wxDefaultSize, 0 );
    itemFlexGridSizer145->Add(m_labSnmpTrapHost, 0, wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL|wxALL, 5);

    m_SnmpTrapHost = new wxTextCtrl( m_ServicePanel, wxID_ANY, wxEmptyString, wxDefaultPosition, wxSize(160, -1), 0 );
    itemFlexGridSizer145->Add(m_SnmpTrapHost, 0, wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL|wxALL, 5);

    m_labSnmpTrapPort = new wxStaticText( m_ServicePanel, wxID_ANY, _("Port"), wxDefaultPosition, wxDefaultSize, 0 );
    itemFlexGridSizer145->Add(m_labSnmpTrapPort, 0, wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL|wxALL, 5);

    m_SnmpTrapPort = new wxSpinCtrl( m_ServicePanel, wxID_ANY, wxT("0"), wxDefaultPosition, wxSize(100, -1), wxSP_ARROW_KEYS, 0, 65536, 0 );
    itemFlexGridSizer145->Add(m_SnmpTrapPort, 0, wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL|wxALL, 5);

    wxStaticBox* itemStaticBoxSizer150Static = new wxStaticBox(m_ServicePanel, wxID_ANY, _("ArchiveBox"));
    wxStaticBoxSizer* itemStaticBoxSizer150 = new wxStaticBoxSizer(itemStaticBoxSizer150Static, wxVERTICAL);
    itemBoxSizer130->Add(itemStaticBoxSizer150, 0, wxGROW|wxALL, 5);
    wxFlexGridSizer* itemFlexGridSizer151 = new wxFlexGridSizer(0, 2, 0, 0);
    itemStaticBoxSizer150->Add(itemFlexGridSizer151, 0, wxGROW, 5);
    m_ABoxHome = new wxTextCtrl( m_ServicePanel, wxID_ANY, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0 );
    itemFlexGridSizer151->Add(m_ABoxHome, 0, wxGROW|wxALIGN_CENTER_VERTICAL|wxALL, 5);

    m_SelectABoxHome = new wxButton( m_ServicePanel, ID_SELECT_ABOXHOME, _("..."), wxDefaultPosition, wxSize(50, -1), 0 );
    itemFlexGridSizer151->Add(m_SelectABoxHome, 0, wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL|wxALL, 5);
    ...
    m_AtomatPanel->SetSizer(itemBoxSizer155);

    wxBoxSizer* itemBoxSizer156 = new wxBoxSizer(wxVERTICAL);
    itemBoxSizer155->Add(itemBoxSizer156, 0, wxALIGN_TOP|wxALL, 5);
    ...
    itemFlexGridSizer157->Add(m_LabelSwTime, 0, wxALIGN_RIGHT|wxALIGN_CENTER_VERTICAL|wxLEFT|wxRIGHT|wxTOP|wxADJUST_MINSIZE, 5);

    m_SwTime = new wxTextCtrl( m_AtomatPanel, ID_TEXTCTRL_RR_SWTIME, _("0"), wxDefaultPosition, wxSize(80, -1), wxTE_CENTRE );
    itemFlexGridSizer157->Add(m_SwTime, 0, wxALIGN_LEFT|wxALIGN_CENTER_VERTICAL|wxLEFT|wxRIGHT|wxTOP, 5);
    ...
    itemFlexGridSizer157->Add(m_LabelMinBKLen, 0, wxALIGN_RIGHT|wxALIGN_CENTER_VERTICAL|wxLEFT|wxRIGHT|wxTOP|wxADJUST_MINSIZE, 5);

    m_MinBKLen = new wxTextCtrl( m_AtomatPanel, ID_TEXTCTRL_RR_MINBKLEN, _("0"), wxDefaultPosition, wxSize(80, -1), wxTE_CENTRE );
    itemFlexGridSizer157->Add(m_MinBKLen, 0, wxALIGN_LEFT|wxALIGN_CENTER_VERTICAL|wxLEFT|wxRIGHT|wxTOP, 5);
    ...
    itemFlexGridSizer157->Add(m_LabelIgnEvt, 0, wxALIGN_RIGHT|wxALIGN_CENTER_VERTICAL|wxLEFT|wxRIGHT|wxTOP|wxADJUST_MINSIZE, 5);

    m_IgnEvt = new wxTextCtrl( m_AtomatPanel, ID_TEXTCTRL_RR_IGNEVT, _("0"), wxDefaultPosition, wxSize(80, -1), wxTE_CENTRE );
    itemFlexGridSizer157->Add(m_IgnEvt, 0, wxALIGN_LEFT|wxALIGN_CENTER_VERTICAL|wxLEFT|wxRIGHT|wxTOP, 5);
    ...
    itemFlexGridSizer157->Add(m_labInitPause, 0, wxALIGN_RIGHT|wxALIGN_CENTER_VERTICAL|wxLEFT|wxRIGHT|wxTOP|wxADJUST_MINSIZE, 5);

    m_PauseInit = new wxTextCtrl( m_AtomatPanel, ID_TEXTCTRL_RR_PAUSEINIT, _("0"), wxDefaultPosition, wxSize(80, -1), wxTE_CENTRE );
    itemFlexGridSizer157->Add(m_PauseInit, 0, wxALIGN_LEFT|wxALIGN_CENTER_VERTICAL|wxLEFT|wxRIGHT|wxTOP, 5);

    m_labInitPower = new wxStaticText( m_AtomatPanel, wxID_ANY, _("Initfield power on"), wxDefaultPosition, wxDefaultSize, 0 );
    itemFlexGridSizer157->Add(m_labInitPower, 0, wxALIGN_RIGHT|wxALIGN_CENTER_VERTICAL|wxLEFT|wxRIGHT, 5);
    ...
    itemFlexGridSizer157->Add(m_SyncRouteTimeout, 0, wxALIGN_LEFT|wxALIGN_CENTER_VERTICAL|wxLEFT|wxRIGHT, 5);

    m_labVirtualTimer = new wxStaticText( m_AtomatPanel, wxID_ANY, _("Virtual timer"), wxDefaultPosition, wxDefaultSize, 0 );
    itemFlexGridSizer157->Add(m_labVirtualTimer, 0, wxALIGN_RIGHT|wxALIGN_CENTER_VERTICAL|wxLEFT|wxRIGHT, 5);

    m_VirtualTimer = new wxSpinCtrl( m_AtomatPanel, wxID_ANY, wxT("1"), wxDefaultPosition, wxSize(80, -1), wxSP_ARROW_KEYS, 1, 60, 1 );
    itemFlexGridSizer157->Add(m_VirtualTimer, 0, wxALIGN_LEFT|wxALIGN_CENTER_VERTICAL|wxLEFT|wxRIGHT, 5);

    itemFlexGridSizer157->AddGrowableCol(1);

    wxStaticLine* itemStaticLine190 = new wxStaticLine( m_AtomatPanel, wxID_STATIC, wxDefaultPosition, wxDefaultSize, wxLI_VERTICAL );
    itemBoxSizer155->Add(itemStaticLine190, 0, wxGROW|wxALL, 5);

    wxFlexGridSizer* itemFlexGridSizer191 = new wxFlexGridSizer(0, 1, 0, 0);
    itemBoxSizer155->Add(itemFlexGridSizer191, 0, wxALIGN_TOP, 5);
    ...
    itemFlexGridSizer191->Add(m_secondNextBlock, 0, wxALIGN_LEFT|wxALIGN_CENTER_VERTICAL|wxLEFT|wxRIGHT|wxTOP, 5);
    ...
    itemFlexGridSizer191->Add(m_EnableSwFb, 0, wxALIGN_LEFT|wxALIGN_CENTER_VERTICAL|wxLEFT|wxRIGHT, 5);
    ...
    itemFlexGridSizer191->Add(m_DisableRouteVreduce, 0, wxALIGN_LEFT|wxALIGN_CENTER_VERTICAL|wxLEFT|wxRIGHT, 5);
    ...
    itemFlexGridSizer191->Add(m_SkipSetSw, 0, wxALIGN_LEFT|wxALIGN_CENTER_VERTICAL|wxLEFT|wxRIGHT, 5);
    ...
    itemFlexGridSizer191->Add(m_SkipSetSg, 0, wxALIGN_LEFT|wxALIGN_CENTER_VERTICAL|wxLEFT|wxRIGHT, 5);
    ...
    itemFlexGridSizer191->Add(m_UseBiCom, 0, wxALIGN_LEFT|wxALIGN_CENTER_VERTICAL|wxLEFT|wxRIGHT, 5);
    ...
    itemFlexGridSizer191->Add(m_CreateGuestOnBiDi, 0, wxALIGN_LEFT|wxALIGN_CENTER_VERTICAL|wxLEFT|wxRIGHT, 5);
    ...
    itemFlexGridSizer191->Add(m_UseBiDiDirection, 0, wxALIGN_LEFT|wxALIGN_CENTER_VERTICAL|wxLEFT|wxRIGHT, 5);
    ...
    itemFlexGridSizer191->Add(m_UseIdent, 0, wxALIGN_LEFT|wxALIGN_CENTER_VERTICAL|wxLEFT|wxRIGHT, 5);
    ...
    itemFlexGridSizer191->Add(m_StopAtIdentMisMatch, 0, wxALIGN_LEFT|wxALIGN_CENTER_VERTICAL|wxLEFT|wxRIGHT, 5);
    ...
    itemFlexGridSizer191->Add(m_PowerOffAtGhost, 0, wxALIGN_LEFT|wxALIGN_CENTER_VERTICAL|wxLEFT|wxRIGHT, 5);
    ...
    itemFlexGridSizer191->Add(m_EBreakAtGhost, 0, wxALIGN_LEFT|wxALIGN_CENTER_VERTICAL|wxLEFT|wxRIGHT, 5);
    ...
    itemFlexGridSizer191->Add(m_KeepGhost, 0, wxALIGN_LEFT|wxALIGN_CENTER_VERTICAL|wxLEFT|wxRIGHT, 5);
    ...
    itemFlexGridSizer191->Add(m_DisableSteal, 0, wxALIGN_LEFT|wxALIGN_CENTER_VERTICAL|wxLEFT|wxRIGHT, 5);
    ...
    itemFlexGridSizer191->Add(m_PowerOffAtReset, 0, wxALIGN_LEFT|wxALIGN_CENTER_VERTICAL|wxLEFT|wxRIGHT, 5);
    ...
    itemFlexGridSizer191->Add(m_ZeroThrottleID, 0, wxALIGN_LEFT|wxALIGN_CENTER_VERTICAL|wxLEFT|wxRIGHT, 5);
    ...
    itemFlexGridSizer191->Add(m_StopNoneCommuter, 0, wxALIGN_LEFT|wxALIGN_CENTER_VERTICAL|wxLEFT|wxRIGHT, 5);
    ...
    itemFlexGridSizer191->Add(m_SyncRoutes, 0, wxALIGN_LEFT|wxALIGN_CENTER_VERTICAL|wxLEFT|wxRIGHT, 5);
    ...
    itemFlexGridSizer191->Add(m_TimedSensors, 0, wxALIGN_LEFT|wxALIGN_CENTER_VERTICAL|wxLEFT|wxRIGHT, 5);
    ...
    itemFlexGridSizer191->Add(m_EnableAnalyzer, 0, wxALIGN_LEFT|wxALIGN_CENTER_VERTICAL|wxLEFT|wxRIGHT, 5);
    ...
    itemFlexGridSizer191->Add(m_ForceUnlock, 0, wxALIGN_LEFT|wxALIGN_CENTER_VERTICAL|wxLEFT|wxRIGHT, 5);
    ...
    itemFlexGridSizer191->Add(m_ReleaseOnIdle, 0, wxALIGN_LEFT|wxALIGN_CENTER_VERTICAL|wxLEFT|wxRIGHT, 5);
    ...
    itemFlexGridSizer191->Add(m_CloseOnGhost, 0, wxALIGN_LEFT|wxALIGN_CENTER_VERTICAL|wxLEFT|wxRIGHT, 5);

    wxStaticLine* itemStaticLine215 = new wxStaticLine( m_AtomatPanel, wxID_STATIC, wxDefaultPosition, wxDefaultSize, wxLI_VERTICAL );
    itemBoxSizer155->Add(itemStaticLine215, 0, wxGROW|wxALL, 5);

    wxBoxSizer* itemBoxSizer216 = new wxBoxSizer(wxVERTICAL);
    itemBoxSizer155->Add(itemBoxSizer216, 0, wxALIGN_TOP|wxALL, 5);
    ...
    itemBoxSizer216->Add(m_UseOnlyFirstIdent, 0, wxALIGN_LEFT|wxLEFT|wxRIGHT, 5);
    ...
    itemBoxSizer216->Add(m_ActionTimer60, 0, wxALIGN_LEFT|wxLEFT|wxRIGHT, 5);
    ...
    itemBoxSizer216->Add(m_RestoreSchedule, 0, wxALIGN_LEFT|wxLEFT|wxRIGHT, 5);
    ...
    itemBoxSizer216->Add(m_SelectShortestBlock, 0, wxALIGN_LEFT|wxLEFT|wxRIGHT, 5);
    ...
    itemBoxSizer216->Add(m_CloseNoEvents, 0, wxALIGN_LEFT|wxLEFT|wxRIGHT, 5);
    ...
    itemBoxSizer216->Add(m_DisableBlockWait4GoManual, 0, wxALIGN_LEFT|wxLEFT|wxRIGHT, 5);
    ...
    itemBoxSizer216->Add(m_StopAtIn4GoManual, 0, wxALIGN_LEFT|wxLEFT|wxRIGHT, 5);
    ...
    itemBoxSizer216->Add(m_V0AtPowerOn, 0, wxALIGN_LEFT|wxLEFT|wxRIGHT, 5);
    ...
    itemBoxSizer216->Add(m_GreenAspect, 0, wxALIGN_LEFT|wxLEFT|wxRIGHT, 5);
    ...
    m_DefAspect->SetSelection(0);
    itemBoxSizer216->Add(m_DefAspect, 0, wxALIGN_LEFT|wxALL, 5);
    ...
    itemBoxSizer216->Add(m_ResetFxSp, 0, wxALIGN_LEFT|wxLEFT|wxRIGHT, 5);
    ...
    itemBoxSizer216->Add(m_ProcessSignalEvents, 0, wxALIGN_LEFT|wxLEFT|wxRIGHT, 5);
    ...
    itemBoxSizer216->Add(m_UseRandomRate, 0, wxALIGN_LEFT|wxLEFT|wxRIGHT, 5);
    ...
    itemBoxSizer216->Add(m_RedirectToMaster, 0, wxALIGN_LEFT|wxLEFT|wxRIGHT, 5);

    m_Weather = new wxCheckBox( m_AtomatPanel, wxID_ANY, _("Weather"), wxDefaultPosition, wxDefaultSize, 0 );
    m_Weather->SetValue(true);
    itemBoxSizer216->Add(m_Weather, 0, wxALIGN_LEFT|wxLEFT|wxRIGHT, 5);
    ...
    itemBoxSizer216->Add(m_V0OnEbreak, 0, wxALIGN_LEFT|wxLEFT|wxRIGHT, 5);
    ...
    wxBoxSizer* itemBoxSizer234 = new wxBoxSizer(wxVERTICAL);
    m_ControllersPanel->SetSizer(itemBoxSizer234);
    ...
    itemBoxSizer234->Add(m_Controllers, 1, wxGROW|wxALL, 5);

    wxBoxSizer* itemBoxSizer236 = new wxBoxSizer(wxHORIZONTAL);
    itemBoxSizer234->Add(itemBoxSizer236, 0, wxGROW|wxALL, 5);
    m_ControllerDelete = new wxButton( m_ControllersPanel, ID_BUTTON_RR_DELETE, _("Delete"), wxDefaultPosition, wxDefaultSize, 0 );
    itemBoxSizer236->Add(m_ControllerDelete, 0, wxALIGN_CENTER_VERTICAL|wxALL, 5);

    m_ControllerProps = new wxButton( m_ControllersPanel, ID_BUTTON_RR_PROPS, _("Properties"), wxDefaultPosition, wxDefaultSize, 0 );
    itemBoxSizer236->Add(m_ControllerProps, 0, wxALIGN_CENTER_VERTICAL|wxALL, 5);

    m_Default = new wxButton( m_ControllersPanel, ID_BUTTON_RR_DEFAULT, _("Default"), wxDefaultPosition, wxDefaultSize, 0 );
    itemBoxSizer236->Add(m_Default, 0, wxALIGN_CENTER_VERTICAL|wxALL, 5);

    wxStaticBox* itemStaticBoxSizer240Static = new wxStaticBox(m_ControllersPanel, wxID_ANY, _("Add Controller"));
    m_AddControllerBox = new wxStaticBoxSizer(itemStaticBoxSizer240Static, wxHORIZONTAL);
    itemBoxSizer234->Add(m_AddControllerBox, 0, wxGROW|wxALL, 5);
    ...
    wxStaticBoxSizer* itemStaticBoxSizer243 = new wxStaticBoxSizer(m_ControllerOptionsBox, wxVERTICAL);
    itemBoxSizer234->Add(itemStaticBoxSizer243, 0, wxGROW|wxALL, 5);
    wxFlexGridSizer* itemFlexGridSizer244 = new wxFlexGridSizer(0, 4, 0, 0);
    itemStaticBoxSizer243->Add(itemFlexGridSizer244, 0, wxGROW, 5);
    ...
    itemFlexGridSizer244->Add(m_PowerOffOnExit, 0, wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL|wxALL, 5);
    ...
    itemFlexGridSizer244->Add(m_PowerOnAtInit, 0, wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL|wxALL, 5);
    ...
    itemFlexGridSizer244->Add(m_Shutdown, 0, wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL|wxALL, 5);
    ...
    itemFlexGridSizer244->Add(m_NoDevCheck, 0, wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL|wxALL, 5);
    ...
    wxBoxSizer* itemBoxSizer250 = new wxBoxSizer(wxVERTICAL);
    m_R2RnetPanel->SetSizer(itemBoxSizer250);

    wxFlexGridSizer* itemFlexGridSizer251 = new wxFlexGridSizer(0, 2, 0, 0);
    itemBoxSizer250->Add(itemFlexGridSizer251, 0, wxGROW|wxALL, 5);
    m_labR2RnetID = new wxStaticText( m_R2RnetPanel, wxID_ANY, _("ID"), wxDefaultPosition, wxDefaultSize, 0 );
    itemFlexGridSizer251->Add(m_labR2RnetID, 0, wxALIGN_RIGHT|wxALIGN_CENTER_VERTICAL|wxALL, 5);

    m_R2RnetID = new wxTextCtrl( m_R2RnetPanel, wxID_ANY, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0 );
    itemFlexGridSizer251->Add(m_R2RnetID, 0, wxGROW|wxALIGN_CENTER_VERTICAL|wxALL, 5);

    m_labR2RnetAddr = new wxStaticText( m_R2RnetPanel, wxID_ANY, _("Address"), wxDefaultPosition, wxDefaultSize, 0 );
    itemFlexGridSizer251->Add(m_labR2RnetAddr, 0, wxALIGN_RIGHT|wxALIGN_CENTER_VERTICAL|wxALL, 5);

    m_R2RnetAddr = new wxTextCtrl( m_R2RnetPanel, wxID_ANY, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0 );
    itemFlexGridSizer251->Add(m_R2RnetAddr, 0, wxGROW|wxALIGN_CENTER_VERTICAL|wxALL, 5);

    m_labR2RnetPort = new wxStaticText( m_R2RnetPanel, wxID_ANY, _("Port"), wxDefaultPosition, wxDefaultSize, 0 );
    itemFlexGridSizer251->Add(m_labR2RnetPort, 0, wxALIGN_RIGHT|wxALIGN_CENTER_VERTICAL|wxALL, 5);

    m_R2RnetPort = new wxSpinCtrl( m_R2RnetPanel, wxID_ANY, wxT("1234"), wxDefaultPosition, wxDefaultSize, wxSP_ARROW_KEYS, 1, 65535, 1234 );
    itemFlexGridSizer251->Add(m_R2RnetPort, 0, wxALIGN_LEFT|wxALIGN_CENTER_VERTICAL|wxALL, 5);

    itemFlexGridSizer251->AddGrowableCol(1);

    wxFlexGridSizer* itemFlexGridSizer258 = new wxFlexGridSizer(0, 3, 0, 0);
    itemBoxSizer250->Add(itemFlexGridSizer258, 0, wxGROW|wxALL, 5);
    m_labR2RnetRoutes = new wxStaticText( m_R2RnetPanel, wxID_ANY, _("Routes file"), wxDefaultPosition, wxDefaultSize, 0 );
    itemFlexGridSizer258->Add(m_labR2RnetRoutes, 0, wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL|wxALL, 5);

    m_R2RnetRoutes = new wxTextCtrl( m_R2RnetPanel, wxID_ANY, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0 );
    itemFlexGridSizer258->Add(m_R2RnetRoutes, 0, wxGROW|wxALIGN_CENTER_VERTICAL|wxALL, 5);

    m_R2RnetRoutesDlg = new wxButton( m_R2RnetPanel, ID_BUTTON_R2RNET_ROUTES, _("..."), wxDefaultPosition, wxSize(30, 25), 0 );
    itemFlexGridSizer258->Add(m_R2RnetRoutesDlg, 0, wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL|wxALL, 5);

    itemFlexGridSizer258->AddGrowableCol(1);
    ...
    itemBoxSizer250->Add(m_R2RnetEnable, 0, wxALIGN_LEFT|wxALL, 5);
    ...
    m_AnalyserPanel->SetSizer(itemBoxSizer264);

    wxFlexGridSizer* itemFlexGridSizer265 = new wxFlexGridSizer(0, 2, 0, 0);
    itemBoxSizer264->Add(itemFlexGridSizer265, 0, wxGROW, 5);
    m_AnaGenerate = new wxStaticBox(m_AnalyserPanel, wxID_ANY, _("Analyze"));
    wxStaticBoxSizer* itemStaticBoxSizer266 = new wxStaticBoxSizer(m_AnaGenerate, wxVERTICAL);
    itemFlexGridSizer265->Add(itemStaticBoxSizer266, 0, wxGROW|wxALIGN_CENTER_VERTICAL|wxLEFT|wxRIGHT|wxTOP, 5);
    ...
    itemStaticBoxSizer266->Add(m_SetRouteId, 0, wxALIGN_LEFT|wxLEFT|wxRIGHT, 5);
    ...
    itemStaticBoxSizer266->Add(m_SetBlockId, 0, wxALIGN_LEFT|wxLEFT|wxRIGHT, 5);
    ...
    itemStaticBoxSizer266->Add(m_AddSignalBlockAssignment, 0, wxALIGN_LEFT|wxLEFT|wxRIGHT, 5);
    ...
    itemStaticBoxSizer266->Add(m_AddFeedbackBlockAssignment, 0, wxALIGN_LEFT|wxLEFT|wxRIGHT, 5);

    m_AnaClean = new wxStaticBox(m_AnalyserPanel, wxID_ANY, _("Clean all Analyze"));
    wxStaticBoxSizer* itemStaticBoxSizer271 = new wxStaticBoxSizer(m_AnaClean, wxVERTICAL);
    itemFlexGridSizer265->Add(itemStaticBoxSizer271, 0, wxGROW|wxALIGN_CENTER_VERTICAL|wxLEFT|wxRIGHT|wxTOP, 5);
    ...
    itemStaticBoxSizer271->Add(m_CleanRouteId, 0, wxALIGN_LEFT|wxLEFT|wxRIGHT, 5);
    ...
    itemStaticBoxSizer271->Add(m_ResetBlockId, 0, wxALIGN_LEFT|wxLEFT|wxRIGHT, 5);
    ...
    itemStaticBoxSizer271->Add(m_ResetSignalBlockAssignment, 0, wxALIGN_LEFT|wxLEFT|wxRIGHT, 5);
    ...
    itemStaticBoxSizer271->Add(m_ResetFeedbackBlockAssignment, 0, wxALIGN_LEFT|wxLEFT|wxRIGHT|wxBOTTOM, 5);

    m_AnaCheck = new wxStaticBox(m_AnalyserPanel, wxID_ANY, _("Extended plan check"));
    wxStaticBoxSizer* itemStaticBoxSizer276 = new wxStaticBoxSizer(m_AnaCheck, wxVERTICAL);
    itemFlexGridSizer265->Add(itemStaticBoxSizer276, 0, wxGROW|wxALIGN_CENTER_VERTICAL|wxLEFT|wxRIGHT|wxTOP, 5);
    ...
    itemStaticBoxSizer276->Add(m_BasicCheck, 0, wxALIGN_LEFT|wxLEFT|wxRIGHT, 5);
    ...
    itemStaticBoxSizer276->Add(m_BlockCheck, 0, wxALIGN_LEFT|wxLEFT|wxRIGHT, 5);
    ...
    itemStaticBoxSizer276->Add(m_RouteCheck, 0, wxALIGN_LEFT|wxLEFT|wxRIGHT, 5);
    ...
    itemStaticBoxSizer276->Add(m_ActionCheck, 0, wxALIGN_LEFT|wxLEFT|wxRIGHT|wxBOTTOM, 5);

    m_AnaReset = new wxStaticBox(m_AnalyserPanel, wxID_ANY, _("Extended plan clean"));
    wxStaticBoxSizer* itemStaticBoxSizer281 = new wxStaticBoxSizer(m_AnaReset, wxVERTICAL);
    itemFlexGridSizer265->Add(itemStaticBoxSizer281, 0, wxGROW|wxALIGN_CENTER_VERTICAL|wxLEFT|wxRIGHT|wxTOP, 5);
    ...
    itemStaticBoxSizer281->Add(m_BasicClean, 0, wxALIGN_LEFT|wxLEFT|wxRIGHT, 5);
    ...
    itemStaticBoxSizer281->Add(m_BlockClean, 0, wxALIGN_LEFT|wxLEFT|wxRIGHT, 5);
    ...
    itemStaticBoxSizer281->Add(m_RouteClean, 0, wxALIGN_LEFT|wxLEFT|wxRIGHT, 5);
    ...
    itemStaticBoxSizer281->Add(m_ActionClean, 0, wxALIGN_LEFT|wxLEFT|wxRIGHT|wxBOTTOM, 5);
    ...
    wxBoxSizer* itemBoxSizer287 = new wxBoxSizer(wxVERTICAL);
    m_RocWebPanel->SetSizer(itemBoxSizer287);

    wxStaticBox* itemStaticBoxSizer288Static = new wxStaticBox(m_RocWebPanel, wxID_ANY, _("Web Service"));
    m_WebServiceBox = new wxStaticBoxSizer(itemStaticBoxSizer288Static, wxVERTICAL);
    itemBoxSizer287->Add(m_WebServiceBox, 0, wxGROW|wxALL, 5);
    wxFlexGridSizer* itemFlexGridSizer289 = new wxFlexGridSizer(0, 5, 0, 0);
    m_WebServiceBox->Add(itemFlexGridSizer289, 0, wxALIGN_LEFT, 5);
    m_LabWebServicePort = new wxStaticText( m_RocWebPanel, wxID_ANY, _("Port"), wxDefaultPosition, wxDefaultSize, 0 );
    itemFlexGridSizer289->Add(m_LabWebServicePort, 0, wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL|wxALL|wxADJUST_MINSIZE, 5);

    m_WebServicePort = new wxSpinCtrl( m_RocWebPanel, wxID_ANY, wxT("0"), wxDefaultPosition, wxSize(120, -1), wxSP_ARROW_KEYS, 0, 65535, 0 );
    itemFlexGridSizer289->Add(m_WebServicePort, 0, wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL|wxALL, 5);

    wxFlexGridSizer* itemFlexGridSizer292 = new wxFlexGridSizer(0, 3, 0, 0);
    m_WebServiceBox->Add(itemFlexGridSizer292, 0, wxGROW, 5);
    m_labWebPath = new wxStaticText( m_RocWebPanel, wxID_ANY, _("Path"), wxDefaultPosition, wxDefaultSize, 0 );
    itemFlexGridSizer292->Add(m_labWebPath, 0, wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL|wxALL, 5);

    m_WebPath = new wxTextCtrl( m_RocWebPanel, wxID_ANY, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0 );
    itemFlexGridSizer292->Add(m_WebPath, 0, wxGROW|wxALIGN_CENTER_VERTICAL|wxLEFT|wxTOP|wxBOTTOM, 5);

    m_WebPathDlg = new wxButton( m_RocWebPanel, ID_ROCWEB_WEB_BUTTON, _("..."), wxDefaultPosition, wxSize(40, 25), 0 );
    itemFlexGridSizer292->Add(m_WebPathDlg, 0, wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL|wxALL, 5);

    itemFlexGridSizer292->AddGrowableCol(1);

    wxStaticBox* itemStaticBoxSizer296Static = new wxStaticBox(m_RocWebPanel, wxID_ANY, _("SVG"));
    wxStaticBoxSizer* itemStaticBoxSizer296 = new wxStaticBoxSizer(itemStaticBoxSizer296Static, wxVERTICAL);
    itemBoxSizer287->Add(itemStaticBoxSizer296, 0, wxGROW|wxALL, 5);
    wxFlexGridSizer* itemFlexGridSizer297 = new wxFlexGridSizer(0, 3, 0, 0);
    itemStaticBoxSizer296->Add(itemFlexGridSizer297, 0, wxGROW|wxALL, 5);
    m_labTheme1 = new wxStaticText( m_RocWebPanel, wxID_ANY, _("Theme 1"), wxDefaultPosition, wxDefaultSize, 0 );
    itemFlexGridSizer297->Add(m_labTheme1, 0, wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL|wxALL, 5);

    m_SVGPath = new wxTextCtrl( m_RocWebPanel, wxID_ANY, _("."), wxDefaultPosition, wxDefaultSize, 0 );
    itemFlexGridSizer297->Add(m_SVGPath, 1, wxGROW|wxALIGN_CENTER_VERTICAL|wxLEFT|wxBOTTOM, 5);

    m_SvgPathDlg = new wxButton( m_RocWebPanel, ID_ROCWEB_SVGPATH_BUTTON, _("..."), wxDefaultPosition, wxSize(40, 25), 0 );
    itemFlexGridSizer297->Add(m_SvgPathDlg, 0, wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL|wxLEFT|wxRIGHT|wxBOTTOM, 5);

    m_labTheme2 = new wxStaticText( m_RocWebPanel, wxID_ANY, _("Theme 2"), wxDefaultPosition, wxDefaultSize, 0 );
    itemFlexGridSizer297->Add(m_labTheme2, 0, wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL|wxALL, 5);

    m_SVGPath2 = new wxTextCtrl( m_RocWebPanel, wxID_ANY, _("."), wxDefaultPosition, wxDefaultSize, 0 );
    itemFlexGridSizer297->Add(m_SVGPath2, 1, wxGROW|wxALIGN_CENTER_VERTICAL|wxLEFT|wxBOTTOM, 5);

    m_SvgPath2Dlg = new wxButton( m_RocWebPanel, ID_ROCWEB_SVGPATH2_BUTTON, _("..."), wxDefaultPosition, wxSize(40, 25), 0 );
    itemFlexGridSizer297->Add(m_SvgPath2Dlg, 0, wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL|wxLEFT|wxRIGHT|wxBOTTOM, 5);

    m_labTheme3 = new wxStaticText( m_RocWebPanel, wxID_ANY, _("Theme 3"), wxDefaultPosition, wxDefaultSize, 0 );
    itemFlexGridSizer297->Add(m_labTheme3, 0, wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL|wxALL, 5);

    m_SVGPath3 = new wxTextCtrl( m_RocWebPanel, wxID_ANY, _("."), wxDefaultPosition, wxDefaultSize, 0 );
    itemFlexGridSizer297->Add(m_SVGPath3, 1, wxGROW|wxALIGN_CENTER_VERTICAL|wxLEFT|wxBOTTOM, 5);

    m_SvgPath3Dlg = new wxButton( m_RocWebPanel, ID_ROCWEB_SVGPATH3_BUTTON, _("..."), wxDefaultPosition, wxSize(40, 25), 0 );
    itemFlexGridSizer297->Add(m_SvgPath3Dlg, 0, wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL|wxLEFT|wxRIGHT|wxBOTTOM, 5);

    m_labTheme4 = new wxStaticText( m_RocWebPanel, wxID_ANY, _("Theme 4"), wxDefaultPosition, wxDefaultSize, 0 );
    itemFlexGridSizer297->Add(m_labTheme4, 0, wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL|wxALL, 5);

    m_SVGPath4 = new wxTextCtrl( m_RocWebPanel, wxID_ANY, _("."), wxDefaultPosition, wxDefaultSize, 0 );
    itemFlexGridSizer297->Add(m_SVGPath4, 1, wxGROW|wxALIGN_CENTER_VERTICAL|wxLEFT|wxBOTTOM, 5);

    m_SvgPath4Dlg = new wxButton( m_RocWebPanel, ID_ROCWEB_SVGPATH4_BUTTON, _("..."), wxDefaultPosition, wxSize(40, 25), 0 );
    itemFlexGridSizer297->Add(m_SvgPath4Dlg, 0, wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL|wxLEFT|wxRIGHT|wxBOTTOM, 5);

    m_labTheme5 = new wxStaticText( m_RocWebPanel, wxID_ANY, _("Theme 5"), wxDefaultPosition, wxDefaultSize, 0 );
    itemFlexGridSizer297->Add(m_labTheme5, 0, wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL|wxALL, 5);

    m_SVGPath5 = new wxTextCtrl( m_RocWebPanel, wxID_ANY, _("."), wxDefaultPosition, wxDefaultSize, 0 );
    itemFlexGridSizer297->Add(m_SVGPath5, 1, wxGROW|wxALIGN_CENTER_VERTICAL|wxLEFT|wxBOTTOM, 5);

    m_SvgPath5Dlg = new wxButton( m_RocWebPanel, ID_ROCWEB_SVGPATH5_BUTTON, _("..."), wxDefaultPosition, wxSize(40, 25), 0 );
    itemFlexGridSizer297->Add(m_SvgPath5Dlg, 0, wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL|wxLEFT|wxRIGHT|wxBOTTOM, 5);

    itemFlexGridSizer297->AddGrowableCol(1);

    m_RRNotebook->AddPage(m_RocWebPanel, _("RocWeb"));

    itemBoxSizer2->Add(m_RRNotebook, 1, wxGROW|wxALL, 5);

    wxStdDialogButtonSizer* itemStdDialogButtonSizer313 = new wxStdDialogButtonSizer;

    itemBoxSizer2->Add(itemStdDialogButtonSizer313, 0, wxGROW|wxLEFT|wxRIGHT, 5);
    m_OK = new wxButton( itemDialog1, wxID_OK, _("&OK"), wxDefaultPosition, wxDefaultSize, 0 );
    m_OK->SetDefault();
    itemStdDialogButtonSizer313->AddButton(m_OK);

    m_Cancel = new wxButton( itemDialog1, wxID_CANCEL, _("&Cancel"), wxDefaultPosition, wxDefaultSize, 0 );
    itemStdDialogButtonSizer313->AddButton(m_Cancel);

    wxButton* itemButton316 = new wxButton( itemDialog1, wxID_HELP, _("&Help"), wxDefaultPosition, wxDefaultSize, 0 );
    itemStdDialogButtonSizer313->AddButton(itemButton316);

    itemStdDialogButtonSizer313->Realize();
...
void RocrailIniDialog::OnButtonPlanfileClick( wxCommandEvent& event )
{
  ...
  if( fdlg->ShowModal() == wxID_OK ) {
    wRocRail.setplanfile(m_Props, fdlg->GetPath().mb_str(wxConvUTF8) );
    m_PlanFile->SetValue( wxString( wRocRail.getplanfile(m_Props),wxConvUTF8) );
  }
}
...
void RocrailIniDialog::OnButtonLocofileClick( wxCommandEvent& event )
{
  ...
  if( fdlg->ShowModal() == wxID_OK ) {
    wRocRail.setlocs(m_Props, fdlg->GetPath().mb_str(wxConvUTF8) );
    m_LocoFile->SetValue( wxString( wRocRail.getlocs(m_Props),wxConvUTF8) );
  }
}
...
void RocrailIniDialog::OnButtonOccfileClick( wxCommandEvent& event )
{
  ...
  if( fdlg->ShowModal() == wxID_OK ) {
    wRocRail.setoccupancy(m_Props, fdlg->GetPath().mb_str(wxConvUTF8) );
    m_OccFile->SetValue( wxString( wRocRail.getoccupancy(m_Props),wxConvUTF8) );
  }
}
  ...
  if( m_Controllers->GetCount() > 1 ) {
    ...
    if( sel != wxNOT_FOUND && sel > 0) {
      ...
      while( controller != NULL ) {
        ...
        controller = wRocRail.getdigint( m_Props );
      };
...
void RocrailIniDialog::OnButtonSoundplayerClick( wxCommandEvent& event )
{
...
void RocrailIniDialog::OnSelectAboxhomeClick( wxCommandEvent& event )
{
  wxDirDialog* dlg = new wxDirDialog( this );
  dlg->SetPath(m_ABoxHome->GetValue());
  if( dlg->ShowModal() == wxID_OK ) {
    m_ABoxHome->SetValue( dlg->GetPath() );
  }
}
