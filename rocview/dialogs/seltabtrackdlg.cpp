...
////@begin SelTabTrackDialog event table entries
    ...
    EVT_BUTTON( wxID_HELP, SelTabTrackDialog::OnHelpClick )
...
////@begin SelTabTrackDialog content construction
    ...
    m_TrackNr = new wxSpinCtrl( itemDialog1, wxID_ANY, _T("0"), wxDefaultPosition, wxSize(100, -1), wxSP_ARROW_KEYS, 0, 47, 0 );
    ...
    itemFlexGridSizer3->Add(m_BlockID, 1, wxGROW|wxALIGN_CENTER_VERTICAL|wxALL, 5);
    ...
    m_Sen1 = new wxComboBox( itemDialog1, wxID_ANY, wxEmptyString, wxDefaultPosition, wxDefaultSize, m_Sen1Strings, wxCB_READONLY );
    itemFlexGridSizer3->Add(m_Sen1, 1, wxGROW|wxALIGN_CENTER_VERTICAL|wxALL, 5);
    ...
    m_Sen2 = new wxComboBox( itemDialog1, wxID_ANY, wxEmptyString, wxDefaultPosition, wxDefaultSize, m_Sen2Strings, wxCB_READONLY );
    itemFlexGridSizer3->Add(m_Sen2, 1, wxGROW|wxALIGN_CENTER_VERTICAL|wxALL, 5);
...
void SelTabTrackDialog::OnHelpClick( wxCommandEvent& event )
{
  wxGetApp().openLink( "seltab-tracks" );
}
