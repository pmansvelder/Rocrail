...
class AboxDlgGen : public wxDialog 
{
	...
	protected:
		...
		virtual void onBmpFind( wxMouseEvent& event ) { event.Skip(); }
		...
		virtual void onBmpAdd( wxMouseEvent& event ) { event.Skip(); }
		...
		virtual void onBmpOpen( wxMouseEvent& event ) { event.Skip(); }
