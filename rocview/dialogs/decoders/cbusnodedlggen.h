...
class cbusnodedlggen : public wxDialog 
{
	...
	protected:
		...
		virtual void onLogo( wxMouseEvent& event ) { event.Skip(); }
		virtual void onGCA( wxMouseEvent& event ) { event.Skip(); }
		...
		virtual void onGC6Servo2LTest( wxCommandEvent& event ) { event.Skip(); }
		virtual void onGC6Servo2RTest( wxCommandEvent& event ) { event.Skip(); }
		virtual void onGC6Servo3LTest( wxCommandEvent& event ) { event.Skip(); }
		virtual void onGC6Servo3RTest( wxCommandEvent& event ) { event.Skip(); }
		virtual void onGC6Servo4LTest( wxCommandEvent& event ) { event.Skip(); }
		virtual void onGC6Servo4RTest( wxCommandEvent& event ) { event.Skip(); }
