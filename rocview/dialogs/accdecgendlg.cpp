...
AccDecGenDlg::AccDecGenDlg( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxDialog( parent, id, title, pos, size, style )
{
	...
	m_labDoc = new wxStaticText( m_GeneralPanel, wxID_ANY, wxT("Documentation"), wxDefaultPosition, wxDefaultSize, 0 );
	m_labDoc->Wrap( -1 );
	fgSizer1->Add( m_labDoc, 0, wxALL|wxALIGN_RIGHT|wxALIGN_CENTER_VERTICAL, 5 );
	...
	m_Docu = new wxTextCtrl( m_GeneralPanel, wxID_ANY, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0 );
	fgSizer5->Add( m_Docu, 0, wxALL|wxEXPAND, 5 );
	
	m_OpenDoc = new wxButton( m_GeneralPanel, wxID_ANY, wxT("..."), wxDefaultPosition, wxSize( 50,-1 ), 0 );
	fgSizer5->Add( m_OpenDoc, 0, wxALL, 5 );
	
	fgSizer1->Add( fgSizer5, 0, wxEXPAND|wxALIGN_CENTER_VERTICAL, 5 );
	...
	m_Notebook->AddPage( m_GeneralPanel, wxT("Generel"), true );
	...
	m_UsagePanel = new wxPanel( m_Notebook, wxID_ANY, wxDefaultPosition, wxDefaultSize, wxTAB_TRAVERSAL );
	wxBoxSizer* bSizer6;
	bSizer6 = new wxBoxSizer( wxVERTICAL );
	
	m_UsageList = new wxListCtrl( m_UsagePanel, wxID_ANY, wxDefaultPosition, wxDefaultSize, wxLC_HRULES|wxLC_REPORT|wxLC_SINGLE_SEL );
	bSizer6->Add( m_UsageList, 1, wxALL|wxEXPAND, 5 );
	
	m_UsagePanel->SetSizer( bSizer6 );
	m_UsagePanel->Layout();
	bSizer6->Fit( m_UsagePanel );
	m_Notebook->AddPage( m_UsagePanel, wxT("Usage"), false );
	...
	m_OpenDoc->Connect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( AccDecGenDlg::onOpenDoc ), NULL, this );
	...
	m_UsageList->Connect( wxEVT_COMMAND_LIST_ITEM_ACTIVATED, wxListEventHandler( AccDecGenDlg::onUsageListActivated ), NULL, this );
	m_UsageList->Connect( wxEVT_COMMAND_LIST_ITEM_SELECTED, wxListEventHandler( AccDecGenDlg::onUsageListSelected ), NULL, this );
...
AccDecGenDlg::~AccDecGenDlg()
{
	...
	m_OpenDoc->Disconnect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( AccDecGenDlg::onOpenDoc ), NULL, this );
	...
	m_UsageList->Disconnect( wxEVT_COMMAND_LIST_ITEM_ACTIVATED, wxListEventHandler( AccDecGenDlg::onUsageListActivated ), NULL, this );
	m_UsageList->Disconnect( wxEVT_COMMAND_LIST_ITEM_SELECTED, wxListEventHandler( AccDecGenDlg::onUsageListSelected ), NULL, this );
