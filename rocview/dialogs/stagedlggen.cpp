...
stagedlggen::stagedlggen( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxDialog( parent, id, title, pos, size, style )
{
	...
	m_Doc = new wxButton( m_Index, wxID_ANY, wxT("Documentation"), wxDefaultPosition, wxDefaultSize, 0 );
	bSizer81->Add( m_Doc, 0, wxALL, 5 );
	...
	m_OwnSectionLength = new wxSpinCtrl( m_Sections, wxID_ANY, wxEmptyString, wxDefaultPosition, wxSize( 120,-1 ), wxSP_ARROW_KEYS, 0, 10000, 0 );
	...
	m_Electrified = new wxCheckBox( m_Details, wxID_ANY, wxT("Electrified"), wxDefaultPosition, wxDefaultSize, 0 );
	fgSizer51->Add( m_Electrified, 0, wxALL, 5 );
	...
	m_Doc->Connect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( stagedlggen::onDoc ), NULL, this );
...
stagedlggen::~stagedlggen()
{
	...
	m_Doc->Disconnect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( stagedlggen::onDoc ), NULL, this );
