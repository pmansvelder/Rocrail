...
cardlggen::cardlggen( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxDialog( parent, id, title, pos, size, style )
{
	...
	m_labNumber->Wrap( -1 );
	fgSizer1->Add( m_labNumber, 0, wxALIGN_RIGHT|wxALIGN_CENTER_VERTICAL|wxTOP|wxRIGHT|wxLEFT, 5 );
	...
	m_labManuId->Wrap( -1 );
	fgSizer3->Add( m_labManuId, 0, wxALIGN_RIGHT|wxALIGN_CENTER_VERTICAL|wxALL, 5 );
	
	m_ManuId = new wxTextCtrl( m_DetailsPanel, wxID_ANY, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0 );
	fgSizer3->Add( m_ManuId, 0, wxEXPAND|wxALIGN_CENTER_VERTICAL|wxALL, 5 );
	
	m_labCatNr = new wxStaticText( m_DetailsPanel, wxID_ANY, wxT("Cat Nr @"), wxDefaultPosition, wxDefaultSize, 0 );
	m_labCatNr->Wrap( -1 );
	fgSizer3->Add( m_labCatNr, 0, wxALL|wxALIGN_RIGHT|wxALIGN_CENTER_VERTICAL, 5 );
	
	m_CatNr = new wxTextCtrl( m_DetailsPanel, wxID_ANY, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0 );
	fgSizer3->Add( m_CatNr, 0, wxALL|wxALIGN_CENTER_VERTICAL|wxEXPAND, 5 );
	...
	m_labID->Connect( wxEVT_LEFT_UP, wxMouseEventHandler( cardlggen::aboxID ), NULL, this );
	m_labRoadname->Connect( wxEVT_LEFT_UP, wxMouseEventHandler( cardlggen::aboxRoadname ), NULL, this );
	...
	m_labManuId->Connect( wxEVT_LEFT_UP, wxMouseEventHandler( cardlggen::aboxManuId ), NULL, this );
	m_labCatNr->Connect( wxEVT_LEFT_UP, wxMouseEventHandler( cardlggen::aboxCatNr ), NULL, this );
...
cardlggen::~cardlggen()
{
	...
	m_labID->Disconnect( wxEVT_LEFT_UP, wxMouseEventHandler( cardlggen::aboxID ), NULL, this );
	m_labRoadname->Disconnect( wxEVT_LEFT_UP, wxMouseEventHandler( cardlggen::aboxRoadname ), NULL, this );
	...
	m_labManuId->Disconnect( wxEVT_LEFT_UP, wxMouseEventHandler( cardlggen::aboxManuId ), NULL, this );
	m_labCatNr->Disconnect( wxEVT_LEFT_UP, wxMouseEventHandler( cardlggen::aboxCatNr ), NULL, this );
